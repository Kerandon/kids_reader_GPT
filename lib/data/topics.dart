...
List<TopicModel> topics = [
  ...
  TopicModel(Topics.fairyTales.name, 'Cinderella'),
  TopicModel(Topics.fairyTales.name, 'Sleeping Beauty'),
  TopicModel(Topics.fairyTales.name, 'Ariel'),
  TopicModel(Topics.fairyTales.name, 'Jasmine'),
  ...
  TopicModel(Topics.beasts.name, 'Rapunzel'),
  TopicModel(Topics.superHeroes.name, 'Superman'),
  TopicModel(Topics.superHeroes.name, 'Spider Man'),
];
